...
const SECTIONS = [
  ...
  { id: "description", title: "2. Description of Service", body: "Career Decode provides AI-powered career guidance including recommendations, skill gap analysis, learning roadmaps, resume analysis, and mock interviews. Output is informational and not professional advice." },
  ...
  { id: "ip", title: "5. Intellectual Property", body: "The Career Decode brand, software, and AI outputs are owned by us or our licensors. You may use generated content for personal career purposes." },
  ...
  { id: "liability", title: "7. Limitation of Liability", body: "To the maximum extent permitted by law, Career Decode is not liable for indirect, incidental, or consequential damages, including lost opportunities or income." },
  ...
  { id: "governing-law", title: "10. Governing Law and Dispute Resolution", body: "These terms are governed by the laws of the jurisdiction in which Career Decode operates. Disputes will be resolved through binding arbitration where permitted." },
